...
public class PaginaInicialController extends SuperPaginaInicialController {

	public static FiltroCanal filtro = new FiltroCanal();

	File file = null;
	Calculador calc = new Calculador();
	Stage stage = null;
	Log arquivoCarregado;

	public static List<AlvoSondaLambda> alvosSonda = new ArrayList<AlvoSondaLambda>();

	public static List<String> listaValoresSonda = new ArrayList<String>();
...
//			tabelaMap.setItems(listaMap);
	...
	public void doAbrirLog() {
		...
		try {
			...
			arquivoCarregado = logGrav.abrirArquivoLog(file);
	...
	protected void doRecarregarArquivo() {
		if (file == null) {
			return;
		}
	...
	private void configurarValoresWideband(List<DataCanal> listaDados, float[] valores, int j) {
		...
		filtro.setStrTpsMinimo(tpsMinimo.getText());
		filtro.setStrTpsMaximo(tpsMaximo.getText());
		filtro.setStrTempMotorMinimo(tempMotorMinimo.getText());
		filtro.setStrTempMotorMaximo(tempMotorMaximo.getText());
		filtro.setStrSondaMinimo(sondaMinimo.getText());
		filtro.setStrSondaMaximo(sondaMaximo.getText());

		if (testaValorMap(valores, j, MAP_m_0_90)) {
			wideMap_map_m_0_90.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_90.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_85)) {
			wideMap_map_m_0_85.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_85.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_80)) {
			wideMap_map_m_0_80.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_80.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_75)) {
			wideMap_map_m_0_75.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_75.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_70)) {
			wideMap_map_m_0_70.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_70.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_65)) {
			wideMap_map_m_0_65.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_65.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_60)) {
			wideMap_map_m_0_60.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_60.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_55)) {
			wideMap_map_m_0_55.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_55.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_50)) {
			wideMap_map_m_0_50.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_50.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_45)) {
			wideMap_map_m_0_45.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_45.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_40)) {
			wideMap_map_m_0_40.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_40.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_35)) {
			wideMap_map_m_0_35.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_35.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_30)) {
			wideMap_map_m_0_30.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_30.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_25)) {
			wideMap_map_m_0_25.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_25.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_20)) {
			wideMap_map_m_0_20.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_20.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_15)) {
			wideMap_map_m_0_15.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_15.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_10)) {
			wideMap_map_m_0_10.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_10.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_m_0_05)) {
			wideMap_map_m_0_05.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_m_0_05.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_00)) {
			wideMap_map_0_00.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_00.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_05)) {
			wideMap_map_0_05.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_05.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_10)) {
			wideMap_map_0_10.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_10.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_20)) {
			wideMap_map_0_20.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_20.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_30)) {
			wideMap_map_0_30.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_30.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_40)) {
			wideMap_map_0_40.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_40.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_50)) {
			wideMap_map_0_50.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_50.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_60)) {
			wideMap_map_0_60.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_60.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_70)) {
			wideMap_map_0_70.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_70.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_80)) {
			wideMap_map_0_80.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_80.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_0_90)) {
			wideMap_map_0_90.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_0_90.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_00)) {
			wideMap_map_1_00.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_00.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_10)) {
			wideMap_map_1_10.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_10.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_20)) {
			wideMap_map_1_20.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_20.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_30)) {
			wideMap_map_1_30.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_30.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_40)) {
			wideMap_map_1_40.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_40.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_50)) {
			wideMap_map_1_50.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_50.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_60)) {
			wideMap_map_1_60.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_60.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_70)) {
			wideMap_map_1_70.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_70.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_80)) {
			wideMap_map_1_80.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_80.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_1_90)) {
			wideMap_map_1_90.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_1_90.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
		if (testaValorMap(valores, j, MAP_2_00)) {
			wideMap_map_2_00.add(utilData.getValorCanal(listaDados, j, Constantes.WIDEBAND, filtro));
			correcaoSondaMap_map_2_00.add(utilData.getValorCanal(listaDados, j, Constantes.SONDA_CORRECAO, filtro));
		}
	}
...
//		DadoTabelaMap dadoTabelaMap = sondaMedia;
	...
	private void atualizarTabela() {
		...
		listaMapDesc.add(desc_mapaMsCorrigidoEditado);
		listaMapDesc.add(desc_mapaMsCorrigido);
		listaMapDesc.add(desc_mapaMs);
		listaMapDesc.add(desc_correcaoLinha);
		listaMapDesc.add(desc_lambdaAlvo);
		listaMapDesc.add(desc_correcaoSondaLinha);
		listaMapDesc.add(desc_sondaMediaDesc);
		listaMapDesc.add(desc_qtdAmostras);
	}
...
//	private Float getValorCanal(List<DataCanal> listaDados, int posicao, Integer canal, Integer sondaCorrecao, boolean isCorrecaoAtiva, String strTpsMinimo, String strTpsMaximo, String strTempMotorMinimo, String strTempMotorMaximo, String strSondaMinimo, String strSondaMaximo) {
//
//		if (canal == sondaCorrecao && !isCorrecaoAtiva) {
//			return null;
//		}
//
//		float vlrTpsMinimo = Float.parseFloat(strTpsMinimo);
//		float vlrTpsMaximo = Float.parseFloat(strTpsMaximo);
//		float vlrTempMotorMinimo = Float.parseFloat(strTempMotorMinimo);
//		float vlrTempMotorMaximo = Float.parseFloat(strTempMotorMaximo);
//		float vlrSondaMinimo = Float.parseFloat(strSondaMinimo);
//		float vlrSondaMaximo = Float.parseFloat(strSondaMaximo);
//
...
//		});
		...
		descricaoLinhaDesc.setCellValueFactory(cellData -> cellData.getValue().getDescricaoLinha());
		...
		atualizarTabela();
		tabelaMap.setItems(listaMap);
		tabelaMapDesc.setItems(listaMapDesc);
