...
public class SuperTabelaDadosController extends InicioController {
...
//	protected static final int POSICAO_QTD_AMOSTRAS = ;
	protected static Integer MAP = 7;
	protected static Integer WIDEBAND_DIGITAL = 113;
	protected static Integer WIDEBAND_ANALOGICO = 9;

	protected Integer WIDEBAND = 113;
	protected Integer SONDA_CORRECAO = 110;
	protected boolean IS_CORRRECAO_ATIVA = false;

	protected static Integer TPS = 100;
	protected static Integer TEMP_MOTOR = 16;
	@FXML
...
//	private Map<Float, BigDecimal> mapaValorMedio = new HashMap<Float, BigDecimal>();
	...
	protected DadoTabelaMap mapaMs = new DadoTabelaMap("Mapa(mS)", "0.206", "0.209", "0.209", "0.293", "0.419", "0.560", "0.774", "1.003", "1.206", "1.493", "1.741", "2.005", "2.269", "2.562", "2.856", "3.150", "3.446", "3.776", "4.068", "4.364", "4.734", "5.189", "5.773", "6.348", "7.017", "8.874",
			"10.730", "11.385", "12.165", "12.782", "13.487", "14.132", "15.000", "15.866", "16.662", "17.286", "18.053", "18.896", "18.896", "18.896");
...
//	}
	...
	public SuperTabelaDadosController() {
		super();
	}
